...
## LLM 协作行为准则（Karpathy Guidelines）

> 来源: [multica-ai/andrej-karpathy-skills](https://github.com/multica-ai/andrej-karpathy-skills)（MIT）。
> 原文保持英文以免翻译失真。与本文件上方的项目规范（嵌入式约束、代码规范等）冲突时，以项目规范为准。
