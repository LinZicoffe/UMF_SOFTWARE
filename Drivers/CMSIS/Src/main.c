...
int main(void)
{
    ...
    while (1)
    {
        ...
        {
            DisplayTimeBase = 0;
            OLED_ShowString(72, 0, strFlowTemBuf, 8, 1);
            OLED_ShowPicture(114, 0, 6, 8, BMP, 1);
            OLED_ShowString(120, 0, "C", 8, 1);
            OLED_ShowString(0, 0, "Tx/Rx ", 8, 1);
            if (ModuleState)
                OLED_ShowString(48, 0, "Err", 8, 1);
            else
                OLED_ShowString(48, 0, " ok", 8, 1);

            OLED_ShowString(0, 16, "RATE", 16, 1);
            OLED_ShowString(80, 16, strFlowRateBuf, 16, 1);
            OLED_ShowString(80, 32, strFlowRate_2Buf, 16, 1);
            OLED_ShowString(104, 32, "L/h", 16, 1);
            OLED_ShowString(0, 48, "TOTAL", 16, 1);
            OLED_ShowString(40, 56, strFlowSumBuf, 8, 1);
            if (Sumunit == 0)
                OLED_ShowString(120, 48, "L", 16, 1);
            else
            {
                OLED_ShowString(112, 56, "  ", 8, 1);
                OLED_ShowString(112, 48, "m", 16, 1);
                OLED_ShowString(120, 56, "3", 8, 1);
            }
            OLED_Refresh();
        }
