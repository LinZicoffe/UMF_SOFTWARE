...
#include <stddef.h>
#include <stdint.h>
/* IAR V8.32 兼容: 不包含 <_ansi.h>，不使用 _BEGIN_STD_C / _END_STD_C */
...
#elif defined(SSD1306_USE_SPI) && !defined(SSD1306_BITBANG_SPI)
/* bit-bang SPI 模式不需要硬件 SPI 句柄 */
extern SPI_HandleTypeDef SSD1306_SPI_PORT;
#elif defined(SSD1306_USE_SPI)
/* SSD1306_BITBANG_SPI: 无需 extern SPI handle */
#else
